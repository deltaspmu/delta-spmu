...
const TOPICS: TopicTile[] = [
  {
    ...
    icon: Stethoscope,
    courseHint: 'professional-certificate-in-ombre-brows-artistry',
  },
  {
    key: 'hygiene-safety',
  ...
  },
  {
    ...
    icon: Palette,
    courseHint: 'professional-certificate-in-lip-blush-lip-neutralization',
  },
  {
    key: 'brow-mapping',
  ...
  },
  {
    ...
    icon: Sparkles,
    courseHint: 'professional-certificate-in-nano-brows-artistry',
  },
  {
    key: 'aftercare',
  ...
  {
    key: 'bridal-artistry',
    titleKey: 'pages:courses.topics.bridal_artistry.title',
    descriptionKey: 'pages:courses.topics.bridal_artistry.description',
    icon: Award,
    courseHint: 'professional-certificate-in-bridal-makeup-artistry',
  },
];
